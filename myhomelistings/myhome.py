...
class Myhome(object):
    ...
    def set_room_type(self, room_type):
        ...
        if not isinstance(room_type, RoomType):
            raise MyhomeException("room_type should be an instance of RoomType.")
    ...
    def set_page(self, page):
        ...
        if not isinstance(page, int) or page < 0:
            raise MyhomeException("Page should be a positive integer.")
    ...
    def set_min_price(self, min_price):
        ...
        if not isinstance(min_price, int):
            raise MyhomeException("Min price should be an integer.")
    ...
    def set_max_price(self, max_price):
        ...
        if not isinstance(max_price, int):
            raise MyhomeException("Max price should be an integer.")
    ...
    def set_listing_type(self, listing_type):
        ...
        if not isinstance(listing_type, SaleType) and not isinstance(listing_type, RentType):
            raise MyhomeException("listing_type should be an instance of SaleType or RentType.")
    ...
    def set_min_beds(self, min_beds):
        ...
        if not isinstance(min_beds, int):
            raise MyhomeException("Minimum number of beds should be an integer.")
    ...
    def set_max_beds(self, max_beds):
        ...
        if not isinstance(max_beds, int):
            raise MyhomeException("Maximum number of beds should be an integer.")
    ...
    def set_sort_by(self, sort_by):
        ...
        if not isinstance(sort_by, SortType):
            raise MyhomeException("sort_by should be an instance of SortType.")
    ...
    def set_sort_order(self, sort_order):
        ...
        if not isinstance(sort_order, SortOrder):
            raise MyhomeException("sort_order should be an instance of SortOrder.")
    ...
    def set_commercial_property_type(self, commercial_property_type):
        ...
        if not isinstance(commercial_property_type, CommercialType):
            raise MyhomeException("commercial_property_type should be an instance of CommercialType.")
    ...
    def set_commercial_min_size(self, commercial_min_size):
        ...
        if not isinstance(commercial_min_size, int):
            raise MyhomeException("commercial_min_size should be an integer.")
    ...
    def set_commercial_max_size(self, commercial_max_size):
        ...
        if not isinstance(commercial_max_size, int):
            raise MyhomeException("commercial_max_size should be an integer.")
    ...
    def set_student_accommodation_type(self, student_accommodation_type):
        ...
        if not isinstance(student_accommodation_type, StudentAccommodationType):
            raise MyhomeException("student_accommodation_type should be an instance of StudentAccommodationType.")
    ...
    def set_property_type(self, property_types):
        ...
        for property_type in property_types:
            if not isinstance(property_type, PropertyType):
                raise MyhomeException("property_types should be an instance of PropertyType.")
    ...
    def get_url(self):
        ...
        if self._result_url:
            if self._page:
                self._result_url += '&page=' + str(self._page)
        ...
        url = self._base + self._county + str(self._listing_type) + str(self._commercial_property_type) + str(
            self._area) + '?page=' + str(self._page) + self._query_params
        return url
    ...
    def search(self):
        ...
        divs = soup.find_all("div", {"class": "propertyDetails"})
